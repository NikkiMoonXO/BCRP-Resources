...
{#if (visible)}
	...
	<div class="speedometer" transition:scale={{ duration: 200, opacity: 0.0, start: 0.0, easing: quintOut }}>
		<Speedometer maxLengthDisplay={72} rotateDegree={230} ringSize={3.5} progressColor={rpm < 0.9? '#F00081' : '#FF3838'} outlineColor={'black'} outlineColorOpacity={0.6} height={60} width={60} progressValue={rpm} text={"MPH"} displayNumber={speed} maxProgressValue={1}/>
