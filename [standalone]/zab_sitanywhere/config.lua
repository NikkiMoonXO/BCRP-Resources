...
config.firstPersonOnSit = false -- This will enable the first person view when the player sits, but this does not force it in first person mode the player can still change the view with V. 
