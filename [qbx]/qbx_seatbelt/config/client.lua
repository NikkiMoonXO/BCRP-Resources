return {
	...
	minSpeedUnbuckled = 120.0, -- Minimum speed to fly through windscreen when seatbelt is off
	minSpeedBuckled = 400.0, -- Minimum speed to fly through windscreen when seatbelt is on
    harness = {
